window.addEventListener('load', function() {
	...
	const SPRITES = {
		...
		'i': {F: 'i.png', L: [76, 112], C: 15, R: 18,N: 260, CH: 'IiÍíÌìĬĭÎîǏǐÏïḮḯĨĩĮįĪīỈỉȈȉȊȋỊịḬḭƗɨᵻᶖİiIıɪƖɩＩｉ'},
		'j': {F: 'j.png', L: [30, 58], C: 15, R: 13,N: 195, CH: 'JjĴĵɈɉJ̌ǰȷʝɟʄᴊＪｊIJijĲĳLJLjlj'},
		'k': {F: 'k.png', L: [54, 84], C: 15, R: 13,N: 184, CH: 'KkḰḱǨǩĶķḲḳḴḵƘƙⱩⱪᶄᶄꝀꝁᴋＫｋ'},
		'l': {F: 'l.png', L: [33, 70], C: 15, R: 24,N: 352, CH: 'LlĹĺĽľĻļḶḷḸḹḼḽḺḻŁłĿŀȽƚⱠⱡⱢɫɬᶅɭȴʟＬｌ'},
